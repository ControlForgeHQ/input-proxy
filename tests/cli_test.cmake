...
function(assert_run_header)
    ...
    if(NOT standard_output MATCHES "^input-proxy [0-9]+\\.[0-9]+\\.[0-9]+")
        message(
            FATAL_ERROR
    ...
    string(REGEX MATCHALL "Repository: https://github.com/fasteddy516/input-proxy" header_matches "${standard_output}")
